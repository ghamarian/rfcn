...
class InceptionResnetV2:
    ...
    def define(inputs, reuse, weightDecay, scope='InceptionResnetV2', trainFrom=None, freezeBatchNorm=False):
        ...
        def beginBlock(name):
            ...
            if (trainFrom is not None) and (not nonlocalTemp["trainBnEntered"]) and (
                ...
                with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride=1, padding='SAME'):
                    ...
                    with tf.variable_scope('Mixed_7a'):
                        with tf.variable_scope('Branch_0'):
                            ...
                            tower_conv_1 = slim.conv2d(tower_conv, 384, 3, stride=2, padding='VALID',
                                                       scope='Conv2d_1a_3x3')
                        with tf.variable_scope('Branch_1'):
    ...
    def __init__(self, name, inputs, trainFrom=None, reuse=False, weightDecay=0.00004, batchNormDecay=0.9997,
                 batchNormEpsilon=0.001, freezeBatchNorm=False):
        self.name = name
        self.inputs = inputs
        ...
        with slim.arg_scope([slim.conv2d, slim.fully_connected],
            ...
            with slim.arg_scope([slim.conv2d],
                ...
                self.endPoints, self.scope, self.scopeList = InceptionResnetV2.define(inputs, weightDecay=weightDecay,
                                                                                      trainFrom=trainFrom, scope=name,
                                                                                      reuse=reuse,
