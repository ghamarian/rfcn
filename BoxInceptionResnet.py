...
class BoxInceptionResnet(BoxNetwork):
    ...
    def __init__(self, inputs, nCategories, name="BoxNetwork", weightDecay=0.00004, freezeBatchNorm=False, reuse=False,
                 isTraining=True, trainFrom=None, hardMining=True):
        ...
        with tf.variable_scope(name, reuse=reuse) as scope:
            ...
            with tf.variable_scope("Box"):
                ...
                with slim.arg_scope([slim.conv2d],
                    ...
                    BoxNetwork.__init__(self, nCategories, rpnInput, 16, [32, 32], featureInput, 16, [32, 32],
